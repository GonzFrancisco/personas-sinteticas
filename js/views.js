...
APP.personas = {
  _this: this,
  init: function () {
    var data = APP.data.personas;
    var list = data.list;

    $(".personas .page-title").html(data.title);
    $(".personas .page-subtitle").html(data.subtitle);
    $(".personas .page-content").html(data.content);
    ...
    // update page
    $(".personas .list").html(l);

    // assign click handlers
    $(".personas .work-item").click(function () {
      APP.sounds["click"].play();
      var link = $(this).attr("data-link");
      console.log("work-item clicked : " + link);
      APP.go(link, true);
  ...
  show: function (dir) {
    console.log("show personas");
    APP.showPage($(".personas"));
    $(".personas .page-title").removeClass("aos-animate");
    $(".personas .page-subtitle").removeClass("aos-animate");
    setTimeout(function () {
      $(".personas .page-title").addClass("aos-animate");
    }, 500);
    setTimeout(function () {
      $(".personas .page-subtitle").addClass("aos-animate");
    }, 500);
  },
  hide: function (dir) {
    console.log("hide personas");
    APP.hidePage($(".personas"));
    $(".personas .page-title").removeClass("aos-animate");
    $(".personas .page-subtitle").removeClass("aos-animate");
  },
};
    ...
    $(".work-detail .share-page-twitter").click(function () {
      window.open(
        "https://twitter.com/intent/tweet?hashtags=" +
          ...
          "&original_referer=" +
          data.url +
          "&ref_src=twsrc%5Etfw&related=synergyseeker&text=" +
          data.twitterShare +
